      ...
      <div className="creator-hero">
        ...
        <p className="creator-hero-trust">
          {creatorLooks.length > 0
            ? `${creatorLooks.length} look${creatorLooks.length === 1 ? '' : 's'} · ${allProducts.length} product${allProducts.length === 1 ? '' : 's'} · trusted by ${trustCount} shoppers`
            : loading
              ? 'Loading catalog...'
              : `Trusted by ${trustCount} shoppers`}
        </p>
