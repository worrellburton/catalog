  ...
  return (
    <div className="deck-view active" ref={containerRef}>
      ...
      <div className="deck-slide">
        ...
        <p className="deck-note" style={{ marginBottom: 24 }}>A creator posts a look featuring a $200 jacket. A shopper buys it through Catalog. Here&apos;s how the economics compare:</p>
      ...
      <div className="deck-slide">
        ...
        <p className="deck-note">The raise is designed to get this flywheel spinning. We start with creators because supply drives organic demand. Every creator who publishes a look brings their own audience, their own trust, and their own distribution.</p>
      </div>
