...
const shoppers = [
  { initials: 'CA', name: 'Carla', color: '#e8f5e9', sso: 'SSO', createdAt: 'Mar 01, 2026', lastSignIn: 'Mar 22, 2026 2:14 PM', shopping: 'Women', location: 'Washington, UK', saved: 0, followings: 0, creator: '-' },
  { initials: 'AL', name: 'alfvaz', color: '#e3f2fd', sso: 'SSO', createdAt: 'Feb 28, 2026', lastSignIn: 'Mar 21, 2026 9:45 AM', shopping: 'Men', location: '-', saved: 0, followings: 1, creator: 'Angelina Oleas' },
  { initials: 'FR', name: 'franky90', color: '#fff3e0', sso: 'Google', createdAt: 'Feb 28, 2026', lastSignIn: 'Mar 20, 2026 6:30 PM', shopping: 'Men', location: '-', saved: 0, followings: 1, creator: 'Angelina Oleas' },
  { initials: 'D1', name: 'D1.barbershop', color: '#f3e5f5', sso: 'Google', createdAt: 'Feb 25, 2026', lastSignIn: 'Mar 15, 2026 11:02 AM', shopping: 'Men', location: '-', saved: 0, followings: 0, creator: '-' },
];
