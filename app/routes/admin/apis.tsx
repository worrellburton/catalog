...
const PROVIDERS: ApiProvider[] = [
  ...
  },
  {
    ...
    category: 'infra',
    scope: 'worker',
    secretKey: 'VITE_MODAL_*_URL (×5)',
    envName: 'VITE env vars (.env / Vercel)',
    status: 'connected',
    purpose: 'Serverless Python workers — site crawler, profile crawler, product scraper, URL resolver, primary-video poster',
    usedBy: ['agents/site-crawler', 'agents/product-scraper', 'agents/url-resolver', 'agents/video-generator'],
    dashboard: 'https://modal.com/apps',
    docs: 'https://modal.com/docs',
    notes: 'VITE_MODAL_CRAWLER_URL · VITE_MODAL_SCRAPER_URL · VITE_MODAL_URL_RESOLVER_URL · VITE_MODAL_PROFILE_CRAWLER_URL · VITE_MODAL_POSTER_URL',
  },
  {
    id: 'spotify',
    name: 'Spotify',
