...
const allSearchItems: SearchItem[] = [
  ...
  { label: 'Deals & Coupons', type: 'Page', to: '/admin/affiliate-com?tab=deals' },
  { label: 'Link Generator', type: 'Page', to: '/admin/affiliate-com?tab=links' },
  { label: 'Commissions', type: 'Page', to: '/admin/affiliate-com?tab=reports' },
