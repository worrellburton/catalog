...
// chips, product text) can retire and let the media breathe; ~0.3s
// after the last scroll event it lifts and the chrome eases back in.
...
// its own wiring. All viewports (founder extended it to desktop);
// reduced-motion users never get the class.
