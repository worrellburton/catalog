...
const CATALOG_TYPE_SYNONYMS: Record<string, string[]> = {
  // Footwear
  // Multi-word forms first (resolver tries longest n-gram first) so
  // "running shoes" narrows to Sneakers instead of expanding to all
  // 8 footwear subtypes via the generic `shoes` fallback.
  ...
  bra:          ['Underwear'],
  bras:         ['Underwear'],
  'sports bra': ['Underwear', 'Activewear'],
  swimwear:     ['Swimwear'],
  swimsuit:     ['Swimwear'],
  bikini:       ['Swimwear'],
  trunks:       ['Swimwear'],
  ...
  perfume:      ['Fragrance'],
  perfumes:     ['Fragrance'],
  'perfume for her': ['Fragrance'],
  'perfume for him': ['Fragrance'],
  cologne:      ['Fragrance'],
  colognes:     ['Fragrance'],
  'fragrance mist': ['Fragrance'],
  skincare:     ['Skincare'],
