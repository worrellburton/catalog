-- Search V8 -> canonical. Promote the aesthetic-routing logic (validated as
-- search_products_v8, eval 18/18) into search_products, and drop the shadow.
-- Rollback: re-apply 20260605000006 (the V7 search_products).
...
drop function if exists public.search_products_v8(vector(384), text, integer, text, uuid[]);
